...
<div class="mws-panel grid_8">
	...
	<div style="height:30px;width:100%;text-align:right; margin-bottom:10px;"><a href="admin.php?cmd=<?php echo $table;?>_ins<?php echo $rif;?>"><button class="btn btn-success"><b>Aggiungi <?php echo $table;?></b></button></a> &nbsp; </div>
