...
<div class="mws-panel grid_8">
	<div style="height:50px;font-size:1.2em;padding-top:10px"><b>Categorie News</b></div>
	
	<div id="start" style="display:none"></div>
	<div id="end" style="display:none"></div>
	<div id="total" style="display:none"></div>
	
	<div style="height:30px;width:100%;text-align:right; margin-bottom:10px;"><a href="admin.php?cmd=<?php echo $table;?>_ins<?php echo $rif;?>"><button class="btn btn-success"><b>Aggiungi Categoria</b></button></a> &nbsp; </div>
	<div class="mws-panel-header">
		<span><i class="icon-table"></i> Elenco Categorie News</span>
	</div>
