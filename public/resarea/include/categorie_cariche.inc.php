...
<div class="mws-panel grid_8">
	<div style="height:50px;font-size:1.2em;padding-top:10px"><b>Categorie Cariche</b></div>
	
	<div id="start" style="display:none"></div>
	<div id="end" style="display:none"></div>
	<div id="total" style="display:none"></div>
	
	<div style="height:30px;width:100%;text-align:right; margin-bottom:10px;"><a href="admin.php?cmd=<?php echo $table;?>_ins<?php echo $rif;?>"><button class="btn btn-success"><b>Aggiungi Categoria Carica</b></button></a> &nbsp; </div>
	<div class="mws-panel-header">
		<span><i class="icon-table"></i> Elenco Categorie Cariche</span>
	</div>
	<div class="mws-panel-body no-padding">
		<table class="mws-datatable-fn mws-table">
			<thead>
				<tr>
					<th style="width:50px;"><input type="checkbox" id="check_tutti" onclick="aggiugni_tutti()"/></th>
					<th style="width:50px;"></th>
					<th style="text-align:left">Nome</th>
					<th style="width:80px;">Bio Visibili</th>
			...
			<?php 
				...
				{					  
					...
					{						
						...
						$nome = $arr_ele['nome'];
						$id_campo = $arr_ele['id'];
						$bio_visibile = $arr_ele['bio_visibile'];
			?>
				<script type="text/javascript">
...
<script type="text/javascript">
  function gestisci_vis(id){
	...
	$("#hiddenFrame").attr("src", "frame/visibileBio.php?id_cat="+id);
  }
</script>