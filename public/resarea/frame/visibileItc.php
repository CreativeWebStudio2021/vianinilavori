...
$query="SELECT visibile FROM ".$prec_db."itc WHERE id='$id_prod'";
$resu = $open_connection->connection->query($query);
list($visibile)=$resu->fetch();

if($visibile==0) $query2="UPDATE ".$prec_db."itc SET visibile='1' WHERE id='$id_prod'";
else  $query2="UPDATE ".$prec_db."itc SET visibile='0' WHERE id='$id_prod'";
