				...
				<div class="mws-form-row">
					...
					<div class="mws-form-item">
						<select name="livello" class="small">
							<option value="300" <?php  if ($level_mod==300) echo "selected=\"selected\""; ?>>Super Amministratore</option>
							<option value="200" <?php  if ($level_mod==200) echo "selected=\"selected\""; ?>>Amministratore</option>
							<option value="100" <?php  if ($level_mod==100) echo "selected=\"selected\""; ?>>Contatti</option>
						</select>
					</div>
				</div>
