		...
		<section style="width:100%; margin-bottom:40px;">
			<div class="mainTextContainer mainTextContainer2" style="margin-bottom:30px;">	
				<div id="subMenuContainer">			  
				  <a href="modello-231.html" title="Modello organizzativo ex D.lgs. 231/2001" class="link-block active">
			...
			<div class="mainTextContainer mainTextContainer2 " style="position:relative; z-index:1;">
				<div class="expand-block__header">
					...
					<div class="expand-block__title" style="margin-bottom:30px;">
						<span style="font-size:30px; font-weight:700">Modello 231</span>
					</div>
				</div>
				@php
					$query_intro = DB::table('testi_introduttivi')
						->select('testo')
						->where('pagina','=','Modello 231')
						->get();
				@endphp
				<div class="expand-block__content" style="margin-top:60px; margin-bottom:60px;">
					{!! $query_intro[0]->testo !!}
				</div>
				...
				<div id="sezLink">
					<ul>
						<li>
							...
							<a id="linkModello" href="{{ mostra_pdf_url('MOG_231_PG_rev._02_del_31.03.2024_Approvato_CDA_del_12.07.2024.pdf', 'Modello organizzativo ex D.lgs. 231/2001 - ' . config('app.name'), 'doc') }}" target="_blank" class="link-block" id="linkModello">
								<span>Clicca qui per la Parte Generale del Modello Organizzativo</span>
								<div class="freccia"></div>
							</a>
						</li>
					</ul>
