...
@section('content')
	@php
		$page_title = "CODICE ETICO<br/>E DI CONDOTTA";
		...
		<section style="width:100%; margin-bottom:40px;">
			<div class="mainTextContainer mainTextContainer2" style="margin-bottom:30px;">	
				<div id="subMenuContainer">			  
				  ...
				  <a href="codice-etico-e-di-condotta.html" title="Codice Etico" class="link-block active">
			...
			<div class="mainTextContainer mainTextContainer2 " style="position:relative; z-index:1;">
				...
				@php
					$query_intro = DB::table('testi_introduttivi')
						->select('testo')
						->where('pagina','=','Codice Etico e di Condotta')
						->get();
				@endphp
				<div class="expand-block__content" style="margin-top:60px; margin-bottom:60px; border:none !important;">
					{!! $query_intro[0]->testo !!}
				</div>
			</div>
		</section>
			...
			<div class="iso-list">					
					<div class="linkList">
							...
							<ul>
								<li style="display: flex; align-items: center;  margin-bottom: 24.2px;">
								  <img class="icon-li" src="{{ asset('web/images/icon_pdf_b.png') }}" alt="Codice Etico - Codice Etico e di Condotta - {{ config('app.name') }}">
									<a href="{{ mostra_pdf_url('Vianini_Lavori_Codice_Etico_CdA_29052025.pdf', 'Codice Etico - ' . config('app.name'), 'doc') }}" title="Codice Etico - Codice Etico e di Condotta - {{ config('app.name') }}" target="_blank" class="link-block">
						...
						<div style="flex:1;">
							<ul>
								<li style="display: flex; align-items: center;  margin-bottom: 24.2px;">
								  <img class="icon-li" src="{{ asset('web/images/icon_pdf_b.png') }}" alt="Codice di Condotta - Codice Etico e di Condotta - {{ config('app.name') }}">
									<a href="{{ mostra_pdf_url('Codice_di_condotta_per_i_fornitori.pdf', 'Codice di Condotta - ' . config('app.name'), 'doc') }}" target="_blank" title="Codice di Condotta - Codice Etico e di Condotta - {{ config('app.name') }}" class="link-block">
									<div class="link-texts">
