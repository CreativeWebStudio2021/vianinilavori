...
class MailController extends Controller {
   public function sendMail($from_email, $from_name, $to_email, $to_name, $subject, $body, $file="",$campo_attachment="attachment", $request="") {
		//dd($request->all());
		...
		try {
			...
			if ($file != "" && is_file($file)) {
				$originalFileName = $request->file($campo_attachment)->getClientOriginalName(); // Ottieni il nome originale
				$send_mail_azi->addAttachment($file, $originalFileName); // Specifica il nome del file
			}
