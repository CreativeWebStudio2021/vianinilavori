@php
	...
	$img_fb=config('app.url')."/public/web/images/logo.png";
...
<meta property="og:image" content="<?php echo $img_fb;?>?<?php echo rand();?>"/>
<link rel="image_src" type="image/jpeg" href="<?php echo $img_fb;?>?<?php echo rand();?>" />
