<?php 
$table="bilanci_sostenibilita";
$pagina="bilanci_sostenibilita";
$directory="files/bilanci";
...
if($campocanc!="")
{
	...
	if(is_file($directory."/$cancimg")){unlink($directory."/$cancimg");}
	/*if(is_file("img_up/slide/s_$cancimg")){unlink("img_up/slide/s_$cancimg");}
	if(is_file("files/slide/$cancimg")){unlink("files/slide/$cancimg");}*/
...
if($stato=="inviato")
{
	...
	$oggetto_admin->modifica_campi("$table" ,$id_rec , $arr_no ,  "", "img_up/slide", $directory);
?>
	<script language="javascript">
		window.location = "admin.php?cmd=<?php echo $table;?><?php echo $rif;?>" ;
	</script>
...
<div class="mws-panel grid_8">
	<div style="height:50px;font-size:1.2em;padding-top:10px"><b>Modifica BILANCI</b></div>
